...
def extract_log_data(log_data):
    """
    Extracts Timestamp, Hostname, Process Info, and Message from log data.
    ...
    Returns:
        ...
        (Timestamp, Hostname, Process Info, Message).
    """
    ...
    for line in log_data.splitlines():
        ...
        if match:
            ...
            extracted_data.append((timestamp, hostname, process_info, message))
